...
public class GlockrHttpConnection 
{
	...
	private static HttpParams GetMyHttpParameters()
	{
		...
		Log.e("----At GlockrHttpConnection class-------","---2222----Post_METHOD----=");
	...
	private static HttpClient GetMyHttpClient() 
	{
		...
		Log.e("----At GlockrHttpConnection class-------","----3333----Post_METHOD----=");
	...
	/*public static boolean isOnline(Context context)
	{
		...
		Log.e("----At GlockrHttpConnection class-------","----444----Post_METHOD----=");
	...
	/*static void HandleUnexpectedHttpError(HttpResponse response) throws Exception 
	{
		int statusCode = response.getStatusLine().getStatusCode();
		String reason = response.getStatusLine().getReasonPhrase();
		throw new Exception("Trouble reading status(code=" + statusCode + "):"+ reason);
	}*/

	public static String GenericHttpMethod(Context context, int operation,String serviceUrl) throws Exception {
		
		Log.e("----At GlockrHttpConnection class-------","----5555---Post_METHOD----=");		
		return GenericHttpMethod(context, operation, serviceUrl);
	}

	public static String GenericHttpMethod(Context context, int operation,String serviceUrl, String jsonMessageBody)throws Exception 
	{
		Log.e("----At GlockrHttpConnection class-------","----1111----Post_METHOD----=");
		//if (!isOnline(context))
			//throw new ConnectionClosedException("No internet connection, please try later");
		String json = null;
		...
		if (jsonMessageBody != null) {
			...
			se.setContentEncoding(new BasicHeader(HTTP.UTF_8/*CONTENT_TYPE*/,"application/json"));
		}
		...
		case POST_METHOD:
			...
			Log.e("----At GlockrHttpConnection class-------","--------Post_METHOD----serviceUrl="+serviceUrl);
			...
			Log.e("----At GlockrHttpConnection class-------","--------Post_METHOD----response="+response.getParams()+"----1="+response);
			break;
		/*case PUT_METHOD:
